...
PerformancePredictor:
  * Add [PerformancePredictor#Elinder](PerformancePredictor#Elinder.md) predicting. Works very well, especially for activities longer than 2h.
...
PerformancePredictor:
  * Age grading as PredictionModel. See the updated documentation: [WAVA](PerformancePredictor#WAVA.md).
  * ExtraPolation new tabs. The effects of Shoes, Age and Utopia (everything combined) can be seen. [Extrapolation](PerformancePredictor#Extrapolation.md).
...
PerformancePredictor updates - Google Code [issue 28](https://code.google.com/p/gps-running/issues/detail?id=28)
...
1.9.286 2011-03-19
  * All: Release resources when popup is closed. This could give a crash when editing an activity after or slower performance. See [issue 24](https://code.google.com/p/gps-running/issues/detail?id=24).
...
1.9.256 2011-01-22
  * HighScore: [issue 20](https://code.google.com/p/gps-running/issues/detail?id=20) Default value for min grade
