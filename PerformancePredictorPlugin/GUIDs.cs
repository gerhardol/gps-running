...
namespace GpsRunningPlugin
{
    class GUIDs
    {
        public static readonly Guid PluginMain = new Guid("0AA49FDF-ADA0-4522-9488-A698A7E197AA");
        //public static readonly Guid Settings = new Guid("86d2e340-1f4f-11e0-ac64-0800200c9a66");
        public static readonly Guid Activity = new   Guid("ee9dde60-5ed6-11df-a08a-0800200c9a66");
...
namespace TrailsPlugin
{
    ...
    {
#if ST_2_1
        public static readonly Guid MapControlLayer = new Guid("86d30a50-1f4f-11e0-ac64-0800200c9a66");
#else
        public static readonly Guid TrailPointsControlLayerProvider = new Guid("86d30a50-1f4f-11e0-ac64-0800200c9a66");
#endif
    }
}