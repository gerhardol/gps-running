...
{
    class TemperatureLabelProvider : TreeList.DefaultLabelProvider
    {
        ...
        {
            TemperatureResult wrapper = (TemperatureResult)element;
            switch(column.Id)
            {
                case ResultColumnIds.Temperature:
                    return UnitUtil.Temperature.ToString(wrapper.Temperature);
